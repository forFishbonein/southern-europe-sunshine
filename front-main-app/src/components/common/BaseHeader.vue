    ...
    <div class="container">
      <div class="getfund-nav-container breakpoint-off">
        ...
        <nav class="getfund-navbar justify-content-between" id="listingNav">
          ...
          <!-- Logo -->
          <a class="nav-brand" href="index.html"><img src="images/logo-header.png" alt="logo"></a>

          <!-- Navbar Toggler -->
          <div class="getfund-navbar-toggler"> <span
          ...
          <div class="getfund-menu">
            ...
            <div class="getfundnav">
              <ul id="responsive">
                <li><a class="current sf-with-ul" href="#">Home</a>
                  <ul class="dropdown">
                ...
                <li class="right-side">
                  <ul>
                    <li><a href="add-listings.html" class="btn btn-primary">Add Listing </a></li>
                  </ul>
                </li>
              </ul>
            </div>
